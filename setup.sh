...
ssh vagrant@192.168.150.201 -i ~/.vagrant.d/insecure_private_key -o "StrictHostKeyChecking no" 'echo -e "password123\npassword123" | sudo passwd root'
ssh vagrant@192.168.150.202 -i ~/.vagrant.d/insecure_private_key -o "StrictHostKeyChecking no" 'echo -e "password123\npassword123" | sudo passwd root'
